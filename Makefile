...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(am__dist_conf_DATA_DIST) \
	$(am__DIST_COMMON)
...
am__dist_conf_DATA_DIST = etc/ethertypes etc/xtables.conf
...
ACLOCAL = ${SHELL} '/home/dl/workspace/thridlib/iptables-1.8.9/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = arm-linux-gnueabihf-ar
AUTOCONF = ${SHELL} '/home/dl/workspace/thridlib/iptables-1.8.9/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/home/dl/workspace/thridlib/iptables-1.8.9/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/home/dl/workspace/thridlib/iptables-1.8.9/build-aux/missing' automake-1.16
AWK = mawk
...
LD = /usr/local/arm/gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/arm-linux-gnueabihf/bin/ld
LDFLAGS = 
LIBOBJS = 
LIBS = 
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} '/home/dl/workspace/thridlib/iptables-1.8.9/build-aux/missing' makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/dl/workspace/thridlib/iptables-1.8.9
abs_srcdir = /home/dl/workspace/thridlib/iptables-1.8.9
abs_top_builddir = /home/dl/workspace/thridlib/iptables-1.8.9
abs_top_srcdir = /home/dl/workspace/thridlib/iptables-1.8.9
ac_ct_AR = 
ac_ct_CC = 
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/dl/workspace/thridlib/iptables-1.8.9/build-aux/install-sh
kbuilddir = 
kinclude_CPPFLAGS = 
ksourcedir = 
...
prefix = /home/dl/workspace/thridlib/iptables-1.8.9/install
...
recheck: all 
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
xlate-test.py.log: xlate-test.py
	@p='xlate-test.py'; \
	b='xlate-test.py'; \
...
iptables-test.py.log: iptables-test.py
	@p='iptables-test.py'; \
	b='iptables-test.py'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
iptables/tests/shell/run-tests.sh.log: iptables/tests/shell/run-tests.sh
	@p='iptables/tests/shell/run-tests.sh'; \
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install-data install-data-am install-dist_confDATA install-dvi \
